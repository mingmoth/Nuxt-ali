        ...
        <div id="ItemPage" class="mt-4 max-w-[1200px] mx-auto px-2">
            <div class="md:flex gap-4 justify-between mx-auto w-full">
                <div class="md:w-[40%]">
                    <img
                        v-if="currentImage"
                        class="rounded-lg object-fit w-[100%] aspect-square bg-slate-300"
                        :src="currentImage"
                    >
                    <div v-if="images[0] !== ''" class="flex items-center justify-between mt-2">
                        <div v-for="image in images">
                            <img
                                @mouseover="currentImage = image"
                                @click="currentImage = image"
                                width="70"
                                class="rounded-md object-fit border-[3px] cursor-pointer bg-slate-200 aspect-square"
